...
echo $apigateway
FILE_PATH="/home/ec2-user/resources/public_policy.json"
FILE_PATH_2="/home/ec2-user/resources/permissions.py"
FILE_PATH_3="/home/ec2-user/resources/setup.sh"
FILE_PATH_4="/home/ec2-user/resources/website/config.js"


##addging from lab 9 (WAF)
FILE_PATH_5="/home/ec2-user/resources/global_waf_acl.json"
FILE_PATH_6="/home/ec2-user/resources/regional_waf_acl.json"
...
sed -i "s/API_GW_BASE_URL_STR: null,/API_GW_BASE_URL_STR: \"https:\/\/${apigateway}.execute-api.us-east-1.amazonaws.com\/prod\",/g" $FILE_PATH_4 ## cambiar por la IP del task ECS productos
sed -i "s/API_GW_REPORT_URL_STR: null,/API_GW_REPORT_URL_STR: \"https:\/\/${apigateway}.execute-api.us-east-1.amazonaws.com\/prod\",/g" $FILE_PATH_4 ## cambiar por la IP del task ECS reportes
...
python3 /home/ec2-user/resources/permissions.py
python3 /home/ec2-user/resources/seed.py
...
### TODO: borrar y reemplazar por un servicio ECS con Fargate
...
global_waf_acl=$(aws wafv2 create-web-acl --cli-input-json file://~/resources/global_waf_acl.json)
echo $global_waf_acl
...
python3 ~/resources/associate_cfront_acl.py $cfront_id $global_acl_arn
...
regional_waf_acl=$(aws wafv2 create-web-acl --cli-input-json file://~/resources/regional_waf_acl.json)
...
python3 ~/resources/associate_apigateway_acl.py $regional_acl_arn $apigateway prod
